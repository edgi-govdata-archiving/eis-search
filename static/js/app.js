...
config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
  ...
  $routeProvider.when('/overview', {redirectTo: '/search/syntax2/'});
  ...
  $routeProvider.when('/search/syntax2/', {templateUrl: '/static/partials/search/syntax2.html', controller: 'SearchCtrl'});
  ...
  $routeProvider.otherwise({redirectTo: '/search/syntax2/'});
